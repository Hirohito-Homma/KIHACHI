...
ありませんでした。語彙は**17 trait / 97表現**しかありません（`dark`/`bright`/`swung`/`straight`/`syncopated`/`on_grid`/`loose`/`tight`は2026-08-17追加）。
...
**1つ目はスキーマ。**返せるtrait名は`intent.TRAIT_WORDS`の17個だけで、polarityは±1、
