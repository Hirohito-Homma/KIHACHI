...
ありませんでした。語彙は**15 trait / 77表現**しかありません（`dark`/`bright`/`swung`/`straight`/`syncopated`/`on_grid`は2026-08-17追加）。
...
**1つ目はスキーマ。**返せるtrait名は`intent.TRAIT_WORDS`の15個だけで、polarityは±1、
